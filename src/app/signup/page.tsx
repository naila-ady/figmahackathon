...
<div className="bg-custom h-[410px] max-w-[1920px]">
    <h1 className="text-white text-center text-4xl pt-40">Sign up page</h1>
   ...
   {/* signup box */}
        ...
        <h1  className='text-[#333333] text-xl font-bold '>Sign Up</h1> 
        </div>
         <div className='max-w-[360px] text-[#333333] text-base font-normal space-y-6 mx-auto'> 
            ...
            <Input placeholder='Password' type="text" className=' text-[#333333] text-base font-normal'/>
             ...
             <div className=' max-w-[424px] space-y-8'>
                 ...
                 <Input placeholder=' Signup' type="text" className='max-w[#424px] text-[#ffffff] bg-[#ff9f0d] text-base font-normal'/>
               </div>
              ...
              <Input placeholder=' Sign up with Google' type="text" className=' text-[#333333] text-base font-normal'/>
            <Input placeholder=' Sign up with Apple' type="text" className=' text-[#333333] text-base font-normal'/>
         </div>
     </div>
    </div>
